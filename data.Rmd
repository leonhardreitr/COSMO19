...
title: "Data"
description: |
  Maybe we could also link to scientific data article if published
---
...
We provide open access to the data of cross-sectional surveys (DATA PAPER MISSING). Data of the panel surveys is available upon request and requires a written data-sharing agreement. Please [contact us](contact.html){style="color: darkred;"} if you want to use the data of COSMO Denmark.
